                ...
                <ul className='navbar-nav m-auto'>
                  ...
                  <li className='nav-item'>
                    ...
                    <ul className='dropdown-menu'>
                      ...
                      <li className='nav-item'>
                        <Link to='/discover-1' activeClassName='active'>
                          <a className='nav-link'>Discover Style One</a>
                        </Link>
                      </li>
                      <li className='nav-item'>
                        <Link to='/discover-2' activeClassName='active'>
                          <a className='nav-link'>Discover Style Two</a>
                        </Link>
                      </li>
                      <li className='nav-item'>
                        <Link to='/item-details' activeClassName='active'>
                  ...
                  <li className='nav-item'>
                    ...
                    <ul className='dropdown-menu'>
                      ...
                      <li className='nav-item'>
                        <Link to='/author-profile' activeClassName='active'>
                      ...
                      <li className='nav-item'>
                        <Link to='/terms-condition' activeClassName='active'>
                  ...
                  <li className='nav-item'>
                    ...
                    <ul className='dropdown-menu'>
                      ...
                      <li className='nav-item'>
                        <Link to='/add-wallet' activeClassName='active'>
