          ...
          <div className='row'>
            <div className='col-lg-12'>
              <div className='item-details-user-card'>
                <div className='item-details-card-img'>
                  <img
                    src={require('../../assets/imgs/Item-details/Item-details-user4.jpg')}
                    alt='Images'
                  />
                </div>
            ...
            <div className='col-lg-12'>
              <div className='item-details-user-card'>
                <div className='item-details-card-img'>
                  <img
                    src={require('../../assets/imgs/Item-details/Item-details-user5.jpg')}
                    alt='Images'
                  />
                </div>
                <div className='item-details-card-content'>
            ...
            <div className='col-lg-12'>
              <div className='item-details-user-card'>
                <div className='item-details-card-img'>
                  <img
                    src={require('../../assets/imgs/Item-details/Item-details-user6.jpg')}
                    alt='Images'
                  />
                </div>
                <div className='item-details-card-content'>
            ...
            <div className='col-lg-12'>
              <div className='item-details-user-card'>
                <div className='item-details-card-img'>
                  <img
                    src={require('../../assets/imgs/Item-details/Item-details-user7.jpg')}
                    alt='Images'
                  />
                </div>
                <div className='item-details-card-content'>
